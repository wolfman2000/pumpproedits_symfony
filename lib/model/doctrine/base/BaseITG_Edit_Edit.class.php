 ...
 * @method integer       getOldUserId()     Returns the current record's "old_user_id" value
 * @method integer       getOldEditId()     Returns the current record's "old_edit_id" value
 ...
 * @method ITG_Edit_Edit setOldUserId()     Sets the current record's "old_user_id" value
 * @method ITG_Edit_Edit setOldEditId()     Sets the current record's "old_edit_id" value
...
abstract class BaseITG_Edit_Edit extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('old_user_id', 'integer', null, array(
             'type' => 'integer',
             'notnull' => true,
             ));
        $this->hasColumn('old_edit_id', 'integer', null, array(
             'type' => 'integer',
             'notnull' => true,
             ));
        ...
        $this->index('old_edit_index', array(
             'fields' => 
             array(
              0 => 'old_edit_id',
             ),
