...
/**
 * PPE_User_Role filter form base class.
 *
 ...
 */
abstract class BasePPE_User_RoleFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ppe_user_role_filters[%s]');
