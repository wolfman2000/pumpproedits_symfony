...
abstract class BasePPE_User_UserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'lc_name'      => new sfWidgetFormFilterInput(),
      'lc_email'     => new sfWidgetFormFilterInput(),
    ));
    ...
    $this->setValidators(array(
      ...
      'lc_name'      => new sfValidatorPass(array('required' => false)),
      'lc_email'     => new sfValidatorPass(array('required' => false)),
    ));
